...
def get_clip_start_time(premiere_clipboard: str):
...
input("In After Effects, select the mask you want to copy, run the JSX script. and copy the results. \n\
    Press enter in this window when ready.")
keys = paste_from_ae()
clip_start_time = get_clip_start_time(premiere_clipboard_data)
encoded_keys = create_premiere_keyframes(keys, clip_start_time)
